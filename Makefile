...
EXE = main
TEST = test
OBJS = main.o Graph.o GraphmlParser.o Kruskals.o traversal/Traversal.o traversal/BFS.o AStar/AStar.o
...
GraphmlParser.o: GraphmlParser.h GraphmlParser.cpp
	$(CXX) $(CXXFLAGS) GraphmlParser.cpp

Kruskals.o: Kruskals.h Kruskals.cpp
	$(CXX) $(CXXFLAGS) Kruskals.cpp

Traversal.o: traversal/Traversal.h traversal/Traversal.cpp
	$(CXX) $(CXXFLAGS) traversal/Traversal.cpp

BFS.o: traversal/BFS.h traversal/BFS.cpp
	$(CXX) $(CXXFLAGS) traversal/BFS.cpp

AStar.o: AStar/AStar.h AStar/AStar.cpp
	$(CXX) $(CXXFLAGS) AStar/AStar.cpp

test : output_msg tests.o 
	$(LD) tests.o Graph.o Graph.o GraphmlParser.o Kruskals.o traversal/Traversal.o traversal/BFS.o AStar/AStar.o $(LDFLAGS) -o test
